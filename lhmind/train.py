...
def train_model(params):
    ...
    # Preprocess data
    (X_train, X_test, y_train, y_test), median_values_dict = preprocess_data(blood_test_data, train_type, reference_values)
    ...
    os.makedirs(disease_type_directory, exist_ok=True)
    ...
    model.save_model(model_file_path, evaluation_result, feature_names, median_values_dict)
